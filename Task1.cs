...
namespace ConsoleApp4
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //        Taking into account that an average crew member on board adds 1.5 units to the draft, a ship that has a draft of more 
            //          than 20 without crew is considered worthy to loot.Any ship weighing that much must have a lot of booty!
    ...
    public class Ship
    {
        ...
        public bool IsWorthIt()
        {
            ...
            if ((Draft * 10 - Crew * 10) > 200) return true;
            else return false;
        }
    }
